...
VALUES 
    ...
    ('Arquitecto de Software', 'Abierta', 'Tecnología', 'Chile', 'Las Condes', 1, 'Me entusiasma la oportunidad de liderar proyectos. Cuento con amplia experiencia en arquitectura de software', 'Ingeniería Civil en Computación', 'AWS, Microservicios, Kubernetes, Java', 3000000, 4000000, 'Presencial', 'Proyecto Interno', 'Senior', '2025-12-01', 7),
